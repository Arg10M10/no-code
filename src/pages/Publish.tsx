...
import { getProjectById, getFiles, Project, setProjectRepoUrl } from "@/lib/projects";
...
const PublishPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const projectFiles = getFiles(projectId);
    const projCode = projectFiles ? projectFiles['index.html'] : null;
